...
MySQL - 5.6.25 : Database - breakdown
*********************************************************************
*/
...
insert  into `jenis`(`kdjenis`,`namajenis`) values ('1','EXCAVATOR'),('10','GRADER'),('11','JENIS LAMA'),('15','jenis'),('2','WATER PUMP 1'),('3','WATER PUMP 2'),('4','WATER PUMP 3'),('5','WATER PUMP'),('6','ARTICULATE'),('7','COMPACTOR'),('8','BULLDOZER'),('9','FUEL TRUCK');
...
insert  into `komponen`(`kdkomp`,`namakomp`,`ketkomp`) values ('001','E','Engine problem'),('002','ES','Electric Sistem'),('003','TR','Transmisi Problem'),('004','DIFF','Gardan Problem'),('005','FD','Final Drive'),('006','BS','Brake Sistem (Rem)'),('007','HS','Hydrolic System'),('008','GET','Part yang habis terkena ke tanah langsung'),('009','ST','Strukture Problem'),('010','UC','Under Cariage (Track)'),('011','T','Tire Problem'),('012','PS','Air System (Angin)'),('013','SE','Stering Sistem'),('014','SU','Suspensi Problem'),('015','GC','General Part (Service,GOH)'),('016','OT','Pengelasan'),('017','nam','nam'),('018','Nama','Komponen');
...
insert  into `merk`(`kdmerk`,`namamerk`) values ('1','KOMATSU'),('2','CAT'),('3','MITSUBISHI'),('4','VOLVO'),('5','HAMM'),('6','BOMAG'),('7','MERK UNIT BARU');
