               ...
               <div class="span12">
                  <div class="widget">
                        <div class="widget-title">
                           <h4><i class="icon-globe"></i>Laporan Grafik Komponen</h4>
                           <span class="tools">
                          ...
                          <form id="form_laporan_komponen">
                            <table class="table table-striped">
                              ...
                              <tr>
                                <td></td>
                                <td>
                                  &nbsp; <button type="button" class="btn btn-sm btn-primary lihat_laporan_komponen">
                            ...
                            <br/>
                            <div id="result_laporan_komponen"></div>
                        </div>
                  </div>
               </div>
            </div>
